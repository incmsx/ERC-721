...
contract NFT is ERC721Upgradeable,ERC721BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable{
    ...
    modifier onlyMinter(uint256 tokenId){
        require(ownerOf(tokenId) == _msgSender(), ERC721InvalidOwner(ownerOf(tokenId)));
        _;
    }
    ...
    function _burnRefund(address minterAddress, uint256 nftPrice, uint256 tokenId) internal onlyMinter(tokenId){
        ...
        emit Refund(minterAddress, tokenId, nftPrice);
    }
